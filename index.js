...
نحن هنا لخدمتك دائمًا، ونتمنى لك تجربة راقية ومميزة معنا 💐🌟`;
    ...
    const message = `مرحبًا عزيزي، نود إبلاغك بأن حسابك على تيليجرام مرتبط برقم هاتف فقط دون اسم مستخدم (Username) وهذا يتعارض مع سياسات الخصوصية الخاصة بنا حيث نعتمد دائمًا على اسم المستخدم لضمان سرية وخصوصية تامة لكل عضو. لهذا السبب لم يتم إنشاء رابط الاستمارة الخاص بك تلقائيًا

ما المطلوب منك الآن؟ يرجى إضافة اسم مستخدم (Username) لحسابك على تيليجرام تمامًا كما تفعل في تطبيقات مثل إنستقرام ويُفضّل أن يكون الاسم واضحًا وسهل القراءة

طريقة إضافة يوزر نيم:
...
يمكنك تقديم الطلب في أي وقت لأن لديك رابط استمارة خاص بك  
ويمكنك الرجوع إلى هذه المحادثة في أي وقت وإعادة التقديم`;
