...
// توكن البوت
const token = '7514683360:AAE3krLLlXY8jm7poIN2mFivA6udWIVOfLY';
...
نحن هنا لخدمتك دائمًا، ونتمنى لك تجربة راقية ومميزة معنا 💐🌟`;
    ...
    bot.sendMessage(chatId, `لم نتمكن من قراءة اسم المستخدم الخاص بك في تيليجرام.  
يرجى الضغط على الزر بالأسفل لإرسال رقم هاتفك حتى نتمكن من توليد رابط استمارة مخصص لك لتسجيل الطلب.`, {
      reply_markup: {
        keyboard: [
          [
            {
